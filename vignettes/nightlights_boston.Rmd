...
```
# Introduction
Increasing nighttime lighting (also referred to as street lighting) is a tool used be police as a strategy for reducing crime across. We have seen historical examples of this such as Boston’s Operation Night Light in the mid-1990s  and a plan in London to install over 3000 street lights in the 1980s  as well as contemporary initiatives such as floodlights installed by the New York Police Department in NYC in 2015  and Dallas’ 2021 public safety plan that includes the installation of new street lights.  Despite this being a popular tool used by police departments, the evidence around the impact of street lighting on crime prevention is highly mixed and there are several studies which suggest that increased nighttime lights has no impact and, in come cases, even increases crime.
...
```
All data were projected into the NAD83 - Massachusetts Mainland ESPG:26986 coordinate system. Additionally, nightlight data were transformed from h5 files to geotiff using a python script and the monthly and long-term means were calculated.
```{r}
