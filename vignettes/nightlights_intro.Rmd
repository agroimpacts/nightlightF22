...
In contrast, in San Francisco, there was a weak correlation (r-squared value < 19%) between the public housing proportion and nighttime radiance. There were very few areas (3 out of 9) with public housing which had higher brightness during nighttime than non-public housing areas. This trend was the same for both 10-year average as well as the winter average of three-month period between December and February.One of the main challenges of the study was a lack of database for all the existing public housing projects in San Francisco. The list of 179 public housing is not an exhaustive one and might have affected the findings.
